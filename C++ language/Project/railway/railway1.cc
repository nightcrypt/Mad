    ...
    if(strcmp(input_password, password)==0)
    {
     ...
     do
     {
        ...
        case 3 :
			...
			break;
        case 4 :
            f1.open("train_details.txt",ios::out|ios::in|ios::binary)
            while(f1.read((char *) & d1, sizeof(d1)))
            {
            d1.display_details();
            }
        ...
        case 5 : 
            f1.open("train_details.txt",ios::out|ios::in|ios::binary);
            f2.open("temp.txt",ios::out|ios::in|ios::binary|ios::app);
            while(f1.read((char *) & d1, sizeof(d1)))
            {
            d1.display_details();
            }
            ...
            rename("train_details.txt","temp.txt");
            break;
...
void newUser()
{
    Login l1;
    fstream f;
    f.open("id.txt",ios::out|ios::in|ios::binary|ios::app);
